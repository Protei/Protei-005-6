...
const int MAX_MOTOR_ROTATIONS[] = {300, 300, 300};

// PID GAIN DEFINITIONS
// *** THESE HAVE NOT BEEN TUNED YET AND MIGHT BE UNSTABLE ***
// I SUGGEST THAT THEY BE TUNEcurrentDriveD WITH THE Ziegler–Nichols METHOD
const int K_PRO[] = {4000, 4000, 4000}; // the proportional gain
const int K_INT[] = {10, 10, 10}; // the intergral gain
